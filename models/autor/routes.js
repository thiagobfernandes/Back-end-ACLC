...
routes.get('/autores', authMiddleware, async (req, res) => {
    const autores = await controller.findAll();
    res.status(200).json(autores);
});

routes.post('/autores', authMiddleware, async (req, res) => {
...
routes.get('/autores/:id', authMiddleware, async (req, res) => {
...
routes.post('/autores/:id', authMiddleware, async (req, res) => {
    const id = Number(req.params.id);
...
routes.delete('/autores/:id', authMiddleware, async (req, res) => {
    const id = Number(req.params.id);
...
routes.get('/autores/nome/:nome', authMiddleware, (req, res) => {
...
routes.post('/autores/filter-by-name', authMiddleware, (req, res) => {
